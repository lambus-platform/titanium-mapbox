...
@objc(TiMapboxExampleProxy)
class TiMapboxExampleProxy: TiProxy {

  override func _init(withPageContext context: TiEvaluator!) -> TiMapboxExampleProxy! {
